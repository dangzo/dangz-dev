...
const ReactionsSkeleton = () => {
  return (
    <div
      className="mt-14 sm:mt-20 flex flex-col flex-wrap items-center gap-3 justify-center border-t border-secondary-light/30 dark:border-secondary-dark/50 pt-8"
