  ...
  return (
    <article>
      ...
      <div className="flex flex-col-reverse md:flex-row mt-6 mb-0 md:mb-8 border-t border-border-light dark:border-border-dark">
        ...
        <aside className="border-border-light/70 px-3 pt-6 pb-0 w-full md:mt-0 md:border-t-0 md:px-2 md:pt-8 md:py-4 md:mb-8 md:min-h-72 md:shrink-0 min-w-45 md:w-75">
          {sidebar}
        </aside>
      </div>
    </article>
